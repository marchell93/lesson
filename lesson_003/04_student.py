...
full_expenses = 12000 + expenses_sum  # TODO У нас есть переменная expenses
...
# TODO Очень много комментариев) Иногда комментарии действительно будут не лишними, но если есть желание комментировать
#  каждую строку, значит с кодом что-то не так. Если делать говорящий нейминг, то в целом будет все понятно и без
#  комментариев
