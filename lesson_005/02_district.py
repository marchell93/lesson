...
# TODO А зачем lesson_005 при импорте? Пакет district лежин на том же уровне, что и этот модуль,
#  так что просто from district. ...

# TODO Можно здесь в один список всех положить -
#  all_people = cen_str_h1r1 + cen_str_h1r2 + ...
...
# TODO И сразу этот список через join пропускать
