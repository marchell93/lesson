...
# TODO Чтобы не зарисовыват радугу, есть два простых варианта - сделать начало снегопада ниже радуги,
#  или рисовать со снегопадом облачко, из которого будут падать снежинки.
#  Вариант посложнее - в simple_draw есть функции take_snapshot - то есть сохранить перед отрисовкой снегопада
#  картинку, и потом поставить ее как фон (для этого надо немного в pygame покапаться, погуглить).
