...
class House:
    ...
    def __str__(self):
        return f"В доме осталось {self.money} денег, {self.food} еды, дом грязный на {self.dirt} процентов"
...
class Wife(Man):
    ...
    def shopping_cat_food(self):
        ...
        self.house.money -= 10
        self.fullness -= 10
        cprint(f'Жена сходила в магазин и купила {self.cat.name} еды!!!', 'yellow')
